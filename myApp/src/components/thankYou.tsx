    ...
    return (
        <div className='flex h-[100vh] items-center justify-center'>
            ...
            <section className=" font-Poppin bg-red-500 opacity-75 self-center rounded-xl p-6">
                ...
                <button type='button' className='border-rose-900 hover:text-white hover:bg-rose-600  flex-1 text-center items-center border-[.5px] p-4 rounded-xl outline-none font-semibold my-4 '>Done</button>
           </div>
            </section>
